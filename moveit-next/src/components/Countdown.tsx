...
export function Countdown() {
    ...
    useEffect(() => {
        if (isActive && time > 0) {
            countdownTimeout = setTimeout(() => { // temos de definir uma função e um tempo de espera.
                setTime(time - 1);
            }, 1000)
    ...
    }, [isActive, time]) // deve-se definir uma função e o(s) gatihlo(s) do efeito colateral.
